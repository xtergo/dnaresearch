...
class WebhookHandler:
    ...
    def process_webhook(self, partner_id: str, event_data: Dict[str, Any], signature: str = None) -> WebhookEvent:
    ...
    def get_partner_events(self, partner_id: str) -> list:
        ...
        return [event for event in self.events.values() if event.partner_id == partner_id]