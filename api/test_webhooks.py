...
def test_webhook_sequencing_complete():
    ...
    webhook_data = {
        ...
        "metadata": {"instrument": "NovaSeq 6000", "run_date": "2025-01-11T10:00:00Z"},
    }
...
def test_webhook_qc_complete():
    ...
    webhook_data = {
        ...
        "qc_metrics": {"passed": True, "quality_score": 35.2, "coverage": "30x"},
    }
...
def test_webhook_with_signature():
    ...
    webhook_data = {"event_type": "sequencing_complete", "sample_id": "sample_004"}
...
def test_webhook_invalid_signature():
    ...
    webhook_data = {"event_type": "sequencing_complete", "sample_id": "sample_005"}
...
def test_webhook_unknown_partner():
    ...
    webhook_data = {"event_type": "sequencing_complete", "sample_id": "sample_006"}

    response = client.post("/webhooks/sequencing/unknown_partner", json=webhook_data)
    assert (
        response.status_code == 200
    )  # Should still process but without signature validation


def test_get_webhook_event():
    """Test getting webhook event details"""
    # First create an event
    webhook_data = {"event_type": "sequencing_complete", "sample_id": "sample_007"}
...
def test_webhook_qc_processing():
    ...
    webhook_data = {
        ...
        "qc_metrics": {"passed": True, "quality_score": 40.5},
    }
...
def test_webhook_analysis_processing():
    ...
    webhook_data = {
        ...
        "analysis_results": {"variant_count": 1234},
    }
