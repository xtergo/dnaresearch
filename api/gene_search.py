...
class GeneSearchEngine:
    ...
    def _load_gene_database(self) -> List[Gene]:
        ...
        return [
            ...
            Gene(
                ...
                aliases=["BRCC2", "BROVCA2", "FACD", "FAD", "FAD1", "FANCD", "FANCD1", "GLM3", "PNCA2", "XRCC11"],
                description="Tumor suppressor gene involved in DNA repair and breast cancer",
                pathways=["dna_repair", "cancer_pathway"]
            ),
            Gene(
            ...
            Gene(
                ...
                aliases=["ABC35", "ABCC7", "CF", "CFTR/MRP", "dJ760C5.1", "MRP7", "TNR-CFTR"],
    ...
    def search(self, query: str, limit: int = 10) -> List[Dict]:
        ...
        if coord_match:
            ...
            for gene in self.genes:
                if (gene.chromosome == chr_name and 
                    not (gene.end < start or gene.start > end)):
